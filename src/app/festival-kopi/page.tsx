...
export default function FestivalKopi() {
  return (
    <SectionLayout>
      ...
      />
      {/* Content */}
      <div className="mx-auto mt-4 rounded-2xl bg-[url('/images/hero-image-2.jpg')] bg-bottom drop-shadow-lg backdrop-brightness-150">
        <div className="flex flex-col justify-center gap-4 rounded-xl bg-black/40 px-3 py-4 lg:flex-row lg:gap-6 lg:px-6 lg:py-8">
